...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);hljs.registerLanguage("r",(()=>{"use strict";function e(...e){return e.map((e=>{
...
end:"`",contains:[{begin:/\\./}]}]}}})());hljs.registerLanguage("json",(()=>{"use strict";return n=>{const e={
...
begin:/^\.\.\.(?=[ ]|$)/}]}]})})());hljs.registerLanguage("http",(()=>{"use strict";return e=>{
...
},{className:"literal",begin:/(-)[\w\d]+/,relevance:0}]},m)}}})());hljs.registerLanguage("diff",(()=>{"use strict";return e=>({name:"Diff",
...
end:/$/}]})})());hljs.registerLanguage("dockerfile",(()=>{"use strict";return e=>({
name:"Dockerfile",aliases:["docker"],case_insensitive:!0,
keywords:"from maintainer expose env arg user onbuild stopsignal",
contains:[e.HASH_COMMENT_MODE,e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,e.NUMBER_MODE,{
beginKeywords:"run cmd entrypoint volume add copy workdir label healthcheck shell",
starts:{end:/[^\\]$/,subLanguage:"bash"}}],illegal:"</"})})());hljs.registerLanguage("ini",(()=>{"use strict";function e(e){
