...
<img src="fridge-setup.jpg" alt="picture of overall fridge setup" style="max-height:400px">
...
from Costco, around 6.0 cubic feet in size with a glass door and wire shelving,
and on balance I think it worked really well - it held humidity pretty decently,
was able to fit a good sized chunk of meat on a shelf, and the glass door let me
...
control top and bottom end temperature would probably be better, but honestly
very pleased with what I got for ~$350 CAD.
...
air quality sensor which promised to monitor temperature, humidity, gas, and
...
I had already, paired with this USB-powered [fan controller](https://www.amazon.ca/dp/B0DPZM7T3Q).
...
fan's cable is much thinner and was easier to route, and the adjustable fan speed
was pretty useful too. I didn't end up needing to adjust it very often at all
because I found that the fan speed being higher didn't change the humidity much
and it messed with the temperature more than I wanted.

Sealing off the cable gaps in the door gasket with foam tape was very helpful in
maintaining temperature. I duct-taped it down first to make sure it stayed attached,
then put foam tape over top to help reduce air leakage.
...
The beef for this first experiment was an ungraded, boneless ribeye roast
weighing 14.2 lbs from Costco. I didn't do a great job of documenting the "before"
state: I forgot to log the total cost and size of the whole roast, but I did
remember to portion off a steak so I could have a before/after tasting. I also
trimmed it up so that it would fit horizontally on the shelf with some space
for airflow around the sides.

The fat cap was thick, the meat wasn't especially marbled, and the spinalis was
thinner than I'd have liked - but I mostly wanted to get a roast I wouldn't be
too upset about ruining if the experiment flopped.
...
Also, I bought the roast and shoved it into the fridge _before_ I did any of this
monitoring setup. It was a good motivator for me actually doing the thing.
...
via a cron job every fifteen minutes on my main home server rather than on the Pi
...
committed every 15 minutes would lead to repository size growing indefinitely).
...
34F-38F, that meat freezes at about 30F, and that the danger zone from a food
safety perspective starts at 40F. I decided to shoot for:

- mean cycle temp between 36F-38F
- 5th percentile above 30F
- 95th percentile at or below 41F
- 80th percentile at or below 40F

These felt like reasonable goals because at no point should the meat itself
actually reach over 41F - the sensor reacts to air temperature swings much faster
than the meat's surface does. I also wanted to avoid short-cycling the fridge
compressor, which would reduce the lifespan of the fridge and also probably cost
more money to run overall.
...
worried that any more time than that being between 40F and 42F would be
more likely to cause spoilage and "bad" bacteria growth.
...
warmer spot of the fridge. This kicked the compressor on a little earlier (at
41F) and also caused it to turn off a bit later (28F), since it took longer for
the "cold" to register on the sensor. That latter part was easy to fix: just
turn the dial down!

I also wanted to try and lengthen the cycle to help the fridge run a little more
...
An interesting note is that when I left for a one-week trip to Croatia, the humidity
started **declining** for the entire period while I was away, but somehow spiked
immediately **before** I got home. This clued me in to a potential reason why the
humidity was sitting so high: when I left, I turned the house's AC off and
programmed it to turn back on shortly before I got back from the trip. The fridge
is in the same room as the furnace and HVAC, and that room gets warmer and more
humid when either the heating or air conidtioning is running. The fridge pulls
that humid air in, which keeps the internal humidity high even after the meat
has lost the moisture it was always going to lose.
...
- Post-trim weight: ~9 lbs (largeish fat cap mostly to blame), cut into 10 steaks
  about 1.5" thick and between 12-14 oz each.

The dry-aged taste was noticeable but not overpowering (especially since I had been
semi-aggressive in trimming off pellicle) - really tasty! I'm very satisfied with
the results. Haven't tried a before/after comparison of flavour and tenderness yet,
I think I'm saving that for when Mi Yen is home next.
